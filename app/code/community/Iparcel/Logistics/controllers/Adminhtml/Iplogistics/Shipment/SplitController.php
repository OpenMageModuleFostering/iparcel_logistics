 ...
 */
class Iparcel_Logistics_Adminhtml_Iplogistics_Shipment_SplitController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function saveAction()
    {
        ...
        try {
            if (Mage::helper('iplogistics/api')->splitShipment($shipment, $itemsCollection)) {
